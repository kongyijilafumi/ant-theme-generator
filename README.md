...
ant-theme-generator是在[antd-theme-generator](https://www.npmjs.com/package/antd-theme-generator)原基础上修改，解决stylesDir文件入口在运行后样式覆盖热更新的值问题。以及`varFile`文件定义的less变量没有`antd`定义的less变量优先级高。

用法和[antd-theme-generator](https://www.npmjs.com/package/antd-theme-generator)一样。
